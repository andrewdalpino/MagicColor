...
def main():
    ...
    for epoch in range(starting_epoch, args.num_epochs + 1):
        total_pixel_l1, total_g_stage_1_l2 = 0.0, 0.0
        ...
        for step, (x, y) in enumerate(
            ...
            if not is_warmup:
                with amp_context:
                    pixel_l2 = pixel_l1_loss.forward(g_pred, y)
                ...
                total_pixel_l1 += pixel_l2.item()
                total_g_stage_1_l2 += g_stage_1_l2.item()
                total_g_bce += g_bce.item()

            total_batches += 1

        average_pixel_l1 = total_pixel_l1 / total_batches
        ...
        logger.add_scalar("Pixel L1", average_pixel_l1, epoch)
